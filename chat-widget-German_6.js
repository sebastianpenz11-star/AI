...
(function() {
    ...
    async function startNewConversation() {
        ...
        try {
            ...
            // Hole den Output (Array oder Objekt) und erlaube HTML-Ausgabe
            const raw = Array.isArray(responseData) ? responseData[0].output : responseData.output;
            botMessageDiv.innerHTML = raw; // HTML wird direkt gerendert
...
document.head.appendChild(thinkingStyles);
    ...
    async function sendMessage(message) {
        ...
        // Holt Output aus Array oder Objekt
        const raw = Array.isArray(data) ? data[0].output : data.output;

        // HTML ausgeben (statt textContent)
